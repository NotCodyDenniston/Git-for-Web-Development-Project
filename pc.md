...
git is a version control system that manages your source code. Github is a hosting service for Git repositories

2. Why do we create a branch? 
To make our own changes independent of the main branch in case something gets messed up.

3. What is the purpose of a pull request? 
A pull request lets you compare two branches before you merge them

4. What is the command you can use to switch between branches? For example you are working on a feature branch and you want to switch back to main. 
git checkout main

5. Explain the difference between `git fetch`, `git merge` and `git pull` what does each command do? 
git fetch gets the latest origin changes without a merge. git pull fetches and merges the latest changes from origin. git merge just merges two branches.

6. What is a merge conflict? How do you resolve a merge conflict? 
A merge conflict happens if two branches have changed the same line of code differently. They can be avoided by fetching and updating from origin frequently. They can be resolved by choosing which code gets put in.
